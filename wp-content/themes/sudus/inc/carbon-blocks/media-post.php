<?php
	...
	function sudus_media_post_fields(){
		...
		Container::make( 'post_meta', __('Вміст мевіа') )
		         ...
		         ->add_fields( array(
			         Field::make_file('sudus_media_video')
			              ->set_value_type('url'),
	...
	function sudus_home_media(){
		Block::make(  __('Our Media') )
		     ...
		     ->set_render_callback( function ( $fields, $attributes, $inner_blocks ) {
			     ...
			     <!-- Медіа-->
			     <section class="media-about-us indent-top-big animation-tracking">
				     <div class="container">
									     ...
									     while ( $mediaList->have_posts() ) : $mediaList->the_post();
										     ...
										     <div class="slide">
											     <div class="video-wrapper">
												     ...
												     >
												     <button class="play" data-video="<?php echo carbon_get_post_meta(get_the_ID(), 'sudus_media_video');?>">
