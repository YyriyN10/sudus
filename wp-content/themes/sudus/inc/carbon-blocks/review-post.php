	...
	function sudus_home_reviews(){
		Block::make(  __('Our Reviews') )
		     ...
		     ->set_render_callback( function ( $fields, $attributes, $inner_blocks ) {
			     ...
			     <!-- Відгуки -->
			     <section class="reviews indent-top-big animation-tracking" id="reviews">
				     <div class="container">
					     ...
					     <div class="row second-up">
						     <div class="slider-wrapper col-12" id="reviews-slider">
                                  ...
                                  >
													        <button class="play" data-video="<?php echo carbon_get_post_meta(get_the_ID(), 'sudus_reviews_video');?>">
